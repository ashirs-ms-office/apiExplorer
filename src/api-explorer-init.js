    ...
    .config(['$routeProvider', '$httpProvider', 'adalAuthenticationServiceProvider', '$mdThemingProvider', function ($routeProvider, $httpProvider, adalProvider, $mdThemingProvider) {
        ...
        adalProvider.init({
                ...
                endpoints: {
                    ...
                    scope:["calendars.readWrite contacts.readWrite files.readWrite files.readAll user.readWrite mail.readWrite mail.send sites.read.all tasks.readWrite people.read notes.readWrite.all"] 
                  } 
